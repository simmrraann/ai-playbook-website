...
const teamMembers = [
  {
    id: 1,
    name: 'Simran',
    role: 'Third Year Engineering (AI & DS)',
    bio: 'Founder of AIJugaad. Builds AI automation for small businesses. Obsessed with making tech feel human.',
    emoji: '🤖',
  ...
  },
  {
    ...
    name: 'Ishan',
    role: 'BBA Student',
    bio: 'The business brain behind the playbook. Turns AI ideas into real-world strategies that actually work.',
    emoji: '📊',
  ...
  },
  {
    ...
    bio: 'Execution wizard and tool master. If there is a workflow to automate, Pranjali has already done it.',
    emoji: '⚡',
  ...
  },
  {
    ...
    bio: 'Full-stack builder with a love for shipping fast. Turns crazy ideas into working products overnight.',
    emoji: '🚀',
  ...
  },
  {
    ...
    bio: 'Design thinker meets growth hacker. Makes sure every product looks as good as it works.',
    emoji: '🎨',
